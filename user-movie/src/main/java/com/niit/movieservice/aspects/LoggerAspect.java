package com.niit.movieservice.aspects;
...
public class LoggerAspect {
    ...
    @Pointcut("execution (* com.niit.movieservice.repository.*.*(..)) || "
    + "execution (* com.niit.movieservice.controller.*.*(..)) || "
    + "execution (* com.niit.movieservice.service.*.*(..))")
...
//    @Around("execution (* com.niit.movieservice.controller.*.*(..))")
//    @Async
