package com.niit.recommended.aspects;
...
public class LoggerAspect {
    ...
    @Pointcut("execution (* com.niit.recommended.repository.*.*(..)) || "
    + "execution (* com.niit.recommended.controller.*.*(..)) || "
    + "execution (* com.niit.recommended.service.*.*(..))")
...
//    @Around("execution (* com.niit.recommended.controller.*.*(..))")
//    @Async
